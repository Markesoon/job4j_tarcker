...
public class BankService {
     ...
     * если такой клиент уже существует в системе, хранилище остается без изменений
    ...
    /**
     * Метод позволяет удалить клиента из банковской системы по данным его паспорта
     *
     ...
     * Если данный клиент найден в системе, и у него нет точно такого же счета,
